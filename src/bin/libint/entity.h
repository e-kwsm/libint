 ...
 */
template <typename T, typename U>
SafePtr<CTimeEntity<typename ProductType<T, U>::result> > operator*(
    const SafePtr<CTimeEntity<T> >& A, const SafePtr<CTimeEntity<U> >& B) {
 ...
 */
template <typename T, typename U>
SafePtr<RTimeEntity<typename ProductType<T, U>::result> > operator*(
    const SafePtr<RTimeEntity<T> >& A, const SafePtr<CTimeEntity<U> >& B) {
