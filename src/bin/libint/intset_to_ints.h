...
class IntegralSet_to_Integrals : public RecurrenceRelation,
 ...
 public:
  ...
  static SafePtr<IntegralSet_to_Integrals<I>> Instance(
      const SafePtr<TargetType>& Tint, unsigned int dir) {
    assert(dir == 0);
    // attempt to construct
    SafePtr<IntegralSet_to_Integrals<I>> this_ptr(
...
template <class I>
SafePtr<typename I::iter_type> IntegralSet_to_Integrals<I>::child(
