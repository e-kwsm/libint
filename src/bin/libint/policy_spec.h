...
struct StdLibintTDPolicy<
  ...
  static void init_subobj(const SafePtr<obj_type>& obj,
                          std::vector<SafePtr<subobj_type>>& subobj) {
    ...
    while (can_iterate) {
      ...
      SafePtr<subobj_type> curr_subobj_sptr =
...
struct StdLibintTDPolicy<GenIntegralSet_1_1<BFS, Oper, AuxQuanta>> {
  ...
  static void init_subobj(const SafePtr<obj_type>& obj,
    ...
    for (gis_siter.init(); gis_siter; ++gis_siter) {
      const SafePtr<typename obj_type::parent_type::iter_type> curr_gis_ptr =
          gis_siter.elem();
      const SafePtr<subobj_type> curr_subobj = subobj_type::Instance(
...
struct StdLibintTDPolicy<R12kG12_11_11<BFS, K>> {
  ...
  static void dealloc_subobj(
      std::vector<SafePtr<R12kG12_11_11<typename BFS::iter_type, K>>>& subobj) {
  }
};
...
struct StdLibintTDPolicy<TiG12_11_11<BFS, K>> {
  ...
  // don't need to be destroyed
  static void dealloc_subobj(
      std::vector<SafePtr<TiG12_11_11<typename BFS::iter_type, K>>>& subobj) {}
};
...
struct StdLibintTDPolicy<R1dotR1G12_11_11<BFS>> {
  ...
  // and don't need to be destroyed
  static void dealloc_subobj(
      std::vector<SafePtr<R1dotR1G12_11_11<typename BFS::iter_type>>>& subobj) {
  }
};
...
struct StdLibintTDPolicy<R2dotR2G12_11_11<BFS>> {
  ...
  // and don't need to be destroyed
  static void dealloc_subobj(
      std::vector<SafePtr<R2dotR2G12_11_11<typename BFS::iter_type>>>& subobj) {
  }
};
...
struct StdLibintTDPolicy<R1dotR2G12_11_11<BFS>> {
  ...
  // and don't need to be destroyed
  static void dealloc_subobj(
      std::vector<SafePtr<R1dotR2G12_11_11<typename BFS::iter_type>>>& subobj) {
  }
};
