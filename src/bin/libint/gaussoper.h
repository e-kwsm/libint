...
LinearCombination<SafePtr<DGVertex>, BraketPair<F, BKType> > R12vec_dot_Nabla1(
    const BraketPair<F, BKType>& bkt) {
  ...
  const auto& f = bkt[0];
  const auto& g = bkt[1];
  typedef LinearCombination<SafePtr<DGVertex>, BraketPair<F, BKType> >
      ResultType;
  ResultType result;
...
template <class F, BraketType BKType>
LinearCombination<SafePtr<DGVertex>, BraketPair<F, BKType> > R12vec_dot_Nabla2(
    const BraketPair<F, BKType>& bkt) {
  if (BKType == CBra || BKType == CKet)
    throw std::logic_error(
...
template <class F, BraketType BKType>
LinearCombination<SafePtr<DGVertex>, BraketPair<F, BKType> > Nabla1(
...
template <class F, BraketType BKType>
LinearCombination<SafePtr<DGVertex>, BraketPair<F, BKType> > Nabla2(
    const BraketPair<F, BKType>& bkt, int xyz) {
  if (BKType == CBra || BKType == CKet)
...
template <class F, BraketType BKType>
LinearCombination<SafePtr<DGVertex>, BraketPair<F, BKType> > R12v(
