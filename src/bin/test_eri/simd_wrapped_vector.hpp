...
class VectorSIMD<Real, 2> {
 public:
  __m256d _avx0;
  VectorSIMD(){};
  VectorSIMD(Real a) { _avx0 = _mm256_set_pd(0, 0, a, a); }

  VectorSIMD(Real (&a)[2]) { _avx0 = _mm256_set_pd(0, 0, a[1], a[0]); }

  VectorSIMD(Real _0, Real _1) { _avx0 = _mm256_set_pd(0, 0, _1, _0); }

  VectorSIMD(__m256d _0) { _avx0 = _0; }
  ...
  void load(Real const* a) { _avx0 = _mm256_loadu_pd(&a[0]); }

  void load_aligned(Real const* a) { _avx0 = _mm256_load_pd(&a[0]); }
...
inline VectorSIMD<double, 2> operator*(VectorSIMD<double, 2> a,
                                       VectorSIMD<double, 2> b) {
  VectorSIMD<double, 2> c;
...
class VectorSIMD<Real, 3> {
 public:
  __m256d _avx0;
  VectorSIMD(){};
  VectorSIMD(Real a) { _avx0 = _mm256_set_pd(0, a, a, a); }

  VectorSIMD(Real (&a)[3]) { _avx0 = _mm256_set_pd(0, a[2], a[1], a[0]); }
  ...
  void convert(Real* a) const { _mm256_storeu_pd(&a[0], _avx0); }

  void convert_aligned(Real* a) const { _mm256_storeu_pd(&a[0], _avx0); }
};
...
inline VectorSIMD<double, 3> operator*(VectorSIMD<double, 3> a,
                                       VectorSIMD<double, 3> b) {
  VectorSIMD<double, 3> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  return c;
}
...
class VectorSIMD<Real, 4> {
 public:
  __m256d _avx0;
  VectorSIMD(){};
  VectorSIMD(Real a) { _avx0 = _mm256_set_pd(a, a, a, a); }

  VectorSIMD(Real (&a)[4]) { _avx0 = _mm256_set_pd(a[3], a[2], a[1], a[0]); }
...
inline VectorSIMD<double, 4> operator*(VectorSIMD<double, 4> a,
                                       VectorSIMD<double, 4> b) {
  VectorSIMD<double, 4> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  return c;
}
...
inline VectorSIMD<double, 5> operator*(VectorSIMD<double, 5> a,
                                       VectorSIMD<double, 5> b) {
  VectorSIMD<double, 5> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
...
inline VectorSIMD<double, 6> operator*(VectorSIMD<double, 6> a,
                                       VectorSIMD<double, 6> b) {
  VectorSIMD<double, 6> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
  return c;
...
inline VectorSIMD<double, 7> operator*(VectorSIMD<double, 7> a,
                                       VectorSIMD<double, 7> b) {
  VectorSIMD<double, 7> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
  return c;
...
inline VectorSIMD<double, 8> operator*(VectorSIMD<double, 8> a,
                                       VectorSIMD<double, 8> b) {
  VectorSIMD<double, 8> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
  return c;
...
inline VectorSIMD<double, 9> operator*(VectorSIMD<double, 9> a,
                                       VectorSIMD<double, 9> b) {
  VectorSIMD<double, 9> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
...
inline VectorSIMD<double, 10> operator*(VectorSIMD<double, 10> a,
                                        VectorSIMD<double, 10> b) {
  VectorSIMD<double, 10> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
  c._avx2 = _mm256_mul_pd(a._avx2, b._avx2);
...
class VectorSIMD<Real, 11> {
 public:
  ...
  VectorSIMD(Real _0, Real _1, Real _2, Real _3, Real _4, Real _5, Real _6,
             Real _7, Real _8, Real _9, Real _10) {
    _avx0 = _mm256_set_pd(_3, _2, _1, _0);
    _avx1 = _mm256_set_pd(_7, _6, _5, _4);
...
inline VectorSIMD<double, 11> operator*(VectorSIMD<double, 11> a,
                                        VectorSIMD<double, 11> b) {
  VectorSIMD<double, 11> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
  c._avx2 = _mm256_mul_pd(a._avx2, b._avx2);
...
class VectorSIMD<Real, 12> {
 public:
  ...
  VectorSIMD(Real _0, Real _1, Real _2, Real _3, Real _4, Real _5, Real _6,
             Real _7, Real _8, Real _9, Real _10, Real _11) {
    _avx0 = _mm256_set_pd(_3, _2, _1, _0);
    _avx1 = _mm256_set_pd(_7, _6, _5, _4);
...
inline VectorSIMD<double, 12> operator*(VectorSIMD<double, 12> a,
                                        VectorSIMD<double, 12> b) {
  VectorSIMD<double, 12> c;
  c._avx0 = _mm256_mul_pd(a._avx0, b._avx0);
  c._avx1 = _mm256_mul_pd(a._avx1, b._avx1);
  c._avx2 = _mm256_mul_pd(a._avx2, b._avx2);
